...
class FixtureDetector:
    ...
    def map_fixtures(self, camera_images, robot_position, fixtures_detected):
        ...
        #for fixture_index, fixture_detected in enumerate(fixtures_detected):
            #if fixture_detected:
                #fixture_position = self.pixel_grid.grid_index_to_coordinates(float(fixture_index))
                #self.victims_coordinates.append(fixture_position)
