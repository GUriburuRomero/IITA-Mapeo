...
class Executor:
    ...
    def state_init(self, change_state_function):
        ...
        self.sequencer.simple_event(self.calibrate_position_offsets) # Calculates offsets in the robot position, in case it doesnt start perfectly centerd
    ...
    def state_explore(self, change_state_function):
        ...
        self.sequencer.seq_reset_sequence() # Resets the sequence but doesnt change state, so it starts all over again.
    ...
    def calibrate_position_offsets(self):
        """Calculates offsets in the robot position, in case it doesnt start perfectly centerd."""
