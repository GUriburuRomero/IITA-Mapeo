...
class PositionFinder(PositionFinderInterface):
    ...
    def update(self, force_calculation=False):
        """
        Calculate closest unseen position if the objective is no longer traversable or if its told to do it with the 'force' parameter.
        """
