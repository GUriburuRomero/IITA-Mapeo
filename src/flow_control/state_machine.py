...
class StateMachine:
    ...
    def change_state(self, new_state):
        ...
        if new_state not in self.possible_states:
            raise ValueError("Cant change state. New state doesnt exist.")
        ...
        if new_state in self.allowed_state_changes[self.state]:
            ...
            print(f"WARNING: Cant change to state {new_state}. New state is not in the possible changes for {self.state}.")
        return True
